  ...
  [6],
  {
    ...
    IKlv: function (e, t, n) {
      ...
      var N = R.props,
        ...
        O = F || ""
      ;(n.p = "".concat(O, "/_next/")),
        b.setConfig({ serverRuntimeConfig: {}, publicRuntimeConfig: L || {} })
      var H = (0, T.getURL)()
      ;(0, _.hasBasePath)(H) && (H = (0, _.delBasePath)(H))
      var X = new x.default(D, O, M),
        U = function (e) {
          var t = f(e, 2),
            n = t[0],
            r = t[1]
          return X.registerPage(n, r)
        }
      window.__NEXT_P &&
                    ...
                    Y.isSsr &&
                      ...
                      Y.replace(
                        Y.pathname +
                          ...
                          String(
                            E.assign(
                              E.urlQueryToSearchParams(Y.query),
              ...
              function (e) {
                for (;;)
                  switch ((e.prev = e.next)) {
                    ...
                    case 30:
                      return (
                        (t.router = Y = (0, A.createRouter)(M, I, H, {
                          initialProps: N,
                          pageLoader: X,
                          App: z,
                          Component: K,
      ...
      function oe(e) {
        ...
        return (
          console.error(n),
          X.loadPage("/_error").then(function (r) {
            var o = r.page,
              a = r.styleSheets,
              i = fe(t),
              u = {
      ...
      function se(e) {
        ...
        return m.default.createElement(
          ...
          m.default.createElement(
            ...
            { value: (0, A.makePublicRouterInstance)(Y) },
            m.default.createElement(
      ...
      var fe = function (e) {
        return function (t) {
          var n = (0, h.default)({}, t, { Component: K, err: k, router: Y })
          return m.default.createElement(
            se,
            null,
    ...
    zmvN: function (e, t, n) {
      ...
      t.looseToArray = l
      var h = d("preload") && !d("prefetch") ? "preload" : "prefetch",
        m = d("preload") ? "preload" : h
            ...
            },
            {
              ...
              value: function (e, t, n) {
                var r = this,
                  ...
                  i = o.query,
                  l = o.search,
                  d = (0, f.parseRelativeUrl)(t).pathname,
                  p = v(a),
                  h = function (e) {
                  ...
                  g = m ? (0, u.interpolateAs)(a, d, i).result : ""
                return m ? g && h(g) : h(p)
              },
            },
            {
              ...
              value: function (e, t) {
                ...
                return Promise.all(
                  document.querySelector(
                    ...
                    ? []
                    : [
                        r && g(r, h, r.endsWith(".css") ? "fetch" : "script"),
                        !t &&
                          this.getDependencies(e).then(function (e) {
                            return Promise.all(
                              e.map(function (e) {
